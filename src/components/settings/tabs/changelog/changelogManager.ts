...
const CHANGELOG_HISTORY_KEY = "VencordChangelog_History";
const LAST_SEEN_HASH_KEY = "VencordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "VencordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "VencordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "VencordChangelog_LastRepoCheck";
