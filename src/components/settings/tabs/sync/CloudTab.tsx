    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom16}>
                Vencord's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                We use our own <Link href="https://github.com/Vencord/Backend"> Vencloud backend</Link> with enhanced features.
                View our <Link href="https://vencord.dev/cloud/privacy">privacy policy</Link> to see what we store and how we use your data.
                Vencloud is BSD 3.0 licensed, so you are free to self-host if preferred.
            </Notice.Info>
            ...
            <Paragraph className={Margins.bottom16}>
                Synchronize your VencordPlusPlus settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.
            </Paragraph>
