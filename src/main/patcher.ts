...
console.log("[VencordPlusPlus] Starting up...");
...
if (!IS_VANILLA) {
    ...
    console.log("[VencordPlusPlus] Running in vanilla mode. Not loading Vencord");
}

console.log("[VencordPlusPlus] Loading original Discord app.asar");
