...
import { ContributorAuthorSummary } from "@plugins/philsPluginLibraryVisualRefresh/components/ContributorAuthorSummary";
import { Author, Contributor } from "@plugins/philsPluginLibraryVisualRefresh/types";
