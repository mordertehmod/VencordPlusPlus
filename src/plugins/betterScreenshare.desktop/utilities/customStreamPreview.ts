...
export const localConsole = {
    ...console,
    log: (...args: any[]): void => console.log("[BetterScreenshare - CustomPreview]:", ...args),
    warn: (...args: any[]): void => console.warn("[BetterScreenshare - CustomPreview]:", ...args),
    error: (...args: any[]): void => console.error("[BetterScreenshare - CustomPreview]:", ...args),
    debug: (...args: any[]): void => console.debug("[BetterScreenshare - CustomPreview]:", ...args),
};
