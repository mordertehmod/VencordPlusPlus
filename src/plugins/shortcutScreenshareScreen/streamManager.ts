...
export async function startStreaming() {
    ...
    showToastCheck("Screenshare started!", Toasts.Type.SUCCESS);
}
...
export function stopStreaming() {
    ...
    showToastCheck("Screenshare stopped!", Toasts.Type.FAILURE);
}
...
function showToastCheck(message: string, type = Toasts.Type.MESSAGE) {
